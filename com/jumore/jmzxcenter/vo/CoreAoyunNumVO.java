...
* @history:
*/
public class CoreAoyunNumVO implements BaseVO {
		/**标识UNID*/
	...
	public void convertPOToVO(Object poObj) {
		...
		CoreAoyunNum po = (CoreAoyunNum) poObj;
				this.cranmUuid = po.getCranmUuid();
				this.cranmWechat = po.getCranmWechat();
				this.cranmNum = po.getCranmNum();
				this.cranmCdate = po.getCranmCdate();
				this.cranmUdate = po.getCranmUdate();
			}
}